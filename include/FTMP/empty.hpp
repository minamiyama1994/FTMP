...
namespace ftmp {
template <typename... T> struct empty<list<T...> > : integral<bool, false> {};
template <> struct empty<list<> > : integral<bool, true> {};
template <typename... seq> struct empty<set<seq...> > : empty<list<seq...> > {};
template <typename... seq>
struct empty<dict<seq...> > : empty<typename to_list<dict<seq...> >::type> {};
}
#endif