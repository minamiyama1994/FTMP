...
namespace ftmp {
template <typename T, typename T1, typename T2 = void> struct insert;
}
#include "FTMP/at.hpp"
...
namespace ftmp {
namespace detail {
template <typename k, typename a, typename dict_> struct insert_dict_helper;
template <typename k, typename a, typename... dict_>
struct insert_dict_helper<k, a, list<dict_...> > : dict<list<k, a>, dict_...> {
};
}
template <typename k, typename a, typename dict_>
struct insert
    : detail::insert_dict_helper<
          k, a, typename filter<
                    ...
                    typename to_list<dict_>::type>::type> {};
template <typename T, typename s>
struct insert<T, s, void> : union_<set<T>, s> {};
}
#endif