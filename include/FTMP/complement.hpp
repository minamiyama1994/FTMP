...
namespace ftmp {
template <typename T1, typename T2> struct complement;
}
...
struct complement<list<T1...>,
                  list<T2...> > : filter<not_<elem<arg<0>, list<T2...> > >,
                                         list<T1...> > {};
template <typename... T1, typename... T2>
struct complement<set<T1...>, set<T2...> > : to_set<typename complement<
                                                 list<T1...>,
                                                 list<T2...> >::type> {};
}
#endif