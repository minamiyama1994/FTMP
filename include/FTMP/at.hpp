...
#define FTMP_AT_HPP
namespace ftmp {
template <typename T, typename index_type> struct at;
}
#include <type_traits>
...
struct skip<integral<index_type, I>, integral<index_type, N>, list<T...>,
            typename std::enable_if<(I == 0)>::type> : id<list<T...> > {};
template <typename index_type, index_type I, index_type N, typename... T>
struct skip<integral<index_type, I>, integral<index_type, N>, list<T...>,
            typename std::enable_if<(I != 0 && I < N / 2)>::
                type> : skip<integral<index_type, I - 1>,
                             integral<index_type, N / 2 - 1>,
                             typename tail<list<T...> >::type> {};
template <typename index_type, index_type I, index_type N, typename... T>
struct skip<
    integral<index_type, I>, integral<index_type, N>, list<T...>,
    typename std::enable_if<(I != 0 && I >= N / 2)>::
        type> : skip<integral<index_type, I - N / 2>,
                     integral<index_type, N - N / 2>,
                     typename skip<integral<index_type, N / 2 - 1>,
                                   integral<index_type, N / 2>,
                                   typename tail<list<T...> >::type>::type> {};
}
template <typename... T, typename index_type, index_type index>
struct at<list<T...>,
          integral<index_type,
                   index> > : head<typename detail::
                                       skip<integral<index_type, index>,
