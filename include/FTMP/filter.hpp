...
namespace ftmp {
template <typename func, typename seq> struct filter;
}
...
struct eval_lambda : lambda<func>::template apply<T>::type::type {};
}
template <typename func, typename seq>
struct filter : foldr<eval_if<detail::eval_lambda<func, arg<0> >,
                              cons<arg<0>, arg<1> >, id<arg<1> > >,
                      list<>, seq> {};
template <typename func, typename... seq>
struct filter<
    func, set<seq...> > : to_set<typename filter<func, list<seq...> >::type> {};
}
#endif