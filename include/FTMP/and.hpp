...
#define FTMP_AND_HPP
namespace ftmp {
template <typename T1, typename T2 = void> struct and_;
}
...
namespace ftmp {
template <typename... T>
struct and_<list<T...>, void> : foldr<and_<arg<0>, arg<1> >,
                                      integral<bool, true>, list<T...> > {};
template <typename T1, typename T2>
struct and_ : not_<typename nand<typename T1::type, typename T2::type>::type> {
};
}
#endif